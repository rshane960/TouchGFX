///////////////////////////////////////////////////////////////////////////////
//
// IAR ANSI C/C++ Compiler V9.20.1.318/W64 for ARM        09/Feb/2022  10:51:30
// Copyright 1999-2021 IAR Systems AB.
//
//    Cpu mode     =  thumb
//    Endian       =  little
//    Source file  =
//        D:\001_Project\B_TouchGFX_Stm32\TouchGFX\MyApplication\TouchGFX\generated\fonts\src\Table_verdana_10_4bpp.cpp
//        [UTF-8]
//    Command line =
//        -f
//        D:\001_Project\B_TouchGFX_Stm32\TouchGFX\MyApplication\EWARM\STM32H7B3I-DK\Obj\TouchGFX\generated\fonts\Table_verdana_10_4bpp.o.rsp
//        (D:\001_Project\B_TouchGFX_Stm32\TouchGFX\MyApplication\TouchGFX\generated\fonts\src\Table_verdana_10_4bpp.cpp
...
//        --dependencies=n
//        D:\001_Project\B_TouchGFX_Stm32\TouchGFX\MyApplication\EWARM\STM32H7B3I-DK\Obj\TouchGFX\generated\fonts\Table_verdana_10_4bpp.o.d
//    Locale       =  C
//    List file    =
//        D:\001_Project\B_TouchGFX_Stm32\TouchGFX\MyApplication\EWARM\STM32H7B3I-DK\List\TouchGFX\generated\fonts\Table_verdana_10_4bpp.s
//
///////////////////////////////////////////////////////////////////////////////
        ...
        EXTERN kerning_verdana_10_4bpp
        EXTERN unicodes_verdana_10_4bpp_0

        PUBLIC _Z23getFont_verdana_10_4bppv
        PUBLIC glyphs_verdana_10_4bpp
        PUBLIC unicodes_verdana_10_4bpp
...
//    5 FONT_TABLE_LOCATION_FLASH_PRAGMA
        ...
        DATA
//    6 KEEP extern const touchgfx::GlyphNode glyphs_verdana_10_4bpp[] FONT_TABLE_LOCATION_FLASH_ATTRIBUTE = {
glyphs_verdana_10_4bpp:
        DATA32
        DC32 0
        DATA16
        DC16 63
        ...
        DATA16
        DS8 2
//    7     {     0, 0x003F,   5,   8,   8,   0,   5,   0,   0, 0x00 }
//    8 };
//    9 
//   10 // verdana_10_4bpp
//   11 FONT_TABLE_LOCATION_FLASH_PRAGMA
//   12 KEEP extern const touchgfx::GlyphNode glyphs_verdana_10_4bpp[] FONT_TABLE_LOCATION_FLASH_ATTRIBUTE;
//   13 FONT_GLYPH_LOCATION_FLASH_PRAGMA
//   14 KEEP extern const uint8_t unicodes_verdana_10_4bpp_0[] FONT_GLYPH_LOCATION_FLASH_ATTRIBUTE;
//   15 FONT_SEARCHTABLE_LOCATION_FLASH_PRAGMA

        SECTION FontSearchFlashSection:CONST:REORDER:ROOT(2)
        DATA
//   16 KEEP extern const uint8_t* const unicodes_verdana_10_4bpp[] FONT_SEARCHTABLE_LOCATION_FLASH_ATTRIBUTE = {
unicodes_verdana_10_4bpp:
        DATA32
        DC32 unicodes_verdana_10_4bpp_0
//   17     unicodes_verdana_10_4bpp_0
//   18 };
//   19 FONT_KERNING_LOCATION_FLASH_PRAGMA
//   20 KEEP extern const touchgfx::KerningNode kerning_verdana_10_4bpp[] FONT_KERNING_LOCATION_FLASH_ATTRIBUTE;
//   21 touchgfx::GeneratedFont& getFont_verdana_10_4bpp();
//   22 

        SECTION `.text`:CODE:NOROOT(2)
          CFI Block cfiBlock0 Using cfiCommon0
          CFI Function _Z23getFont_verdana_10_4bppv
        THUMB
//   23 touchgfx::GeneratedFont& getFont_verdana_10_4bpp()
//   24 {
_Z23getFont_verdana_10_4bppv:
        ...
        SUB      SP,SP,#+44     
          CFI CFA R13+48
        LDR.N    R1,??getFont_verdana_10_4bpp_0
        LDRB     R0,[R1, #+0]   
        CMP      R0,#+0         
        BNE.N    ??getFont_verdana_10_4bpp_1
//   25     static touchgfx::GeneratedFont verdana_10_4bpp(glyphs_verdana_10_4bpp, 1, 10, 0, 4, 1, 0, 0, unicodes_verdana_10_4bpp, kerning_verdana_10_4bpp, 63, 0, 0, 0);
        MOVS     R0,#+1         
        STRB     R0,[R1, #+0]   
        MOVS     R0,#+0         
        STR      R0,[SP, #+40]  
        ...
        MOVS     R0,#+63        
        STR      R0,[SP, #+28]  
        LDR.N    R0,??getFont_verdana_10_4bpp_0+0x4
        STR      R0,[SP, #+24]  
        LDR.N    R0,??getFont_verdana_10_4bpp_0+0x8
        STR      R0,[SP, #+20]  
        MOVS     R0,#+0         
        STR      R0,[SP, #+16]  
        MOVS     R0,#+0         
        ...
        MOVS     R3,#+10        
        MOVS     R2,#+1         
        LDR.N    R1,??getFont_verdana_10_4bpp_0+0xC
        LDR.N    R0,??getFont_verdana_10_4bpp_0+0x10
...
//   26     return verdana_10_4bpp;
??getFont_verdana_10_4bpp_1:
        LDR.N    R0,??getFont_verdana_10_4bpp_0+0x10
        ADD      SP,SP,#+44     
          CFI CFA R13+4
        POP      {PC}           
        Nop                     
        DATA
??getFont_verdana_10_4bpp_0:
        DATA32
        DC32     `getFont_verdana_10_4bpp()::static guard for verdana_10_4bpp`
        DC32     kerning_verdana_10_4bpp
        DC32     unicodes_verdana_10_4bpp
        DC32     glyphs_verdana_10_4bpp
        DC32     `getFont_verdana_10_4bpp()::verdana_10_4bpp`
//   27 }
          CFI EndBlock cfiBlock0

        SECTION `.bss`:DATA:REORDER:NOROOT(0)
        DATA
// __absolute unsigned char static guard for verdana_10_4bpp
`getFont_verdana_10_4bpp()::static guard for verdana_10_4bpp`:
        DS8 1

        SECTION `.bss`:DATA:REORDER:NOROOT(2)
        DATA
`getFont_verdana_10_4bpp()::verdana_10_4bpp`:
        DS8 40
